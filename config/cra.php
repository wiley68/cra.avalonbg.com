...
return [
    'roles' => [
        ...
        RoleSlug::OrganizationOwner->value => [
            ...
            'permissions' => [
                ...
                PermissionSlug::ComponentsView->value,
                PermissionSlug::ComponentsManage->value,
                ...
                PermissionSlug::TasksView->value,
                PermissionSlug::TasksManage->value,
                PermissionSlug::TasksApprove->value,
                PermissionSlug::AuditView->value,
            ],
        ],
    ...
    'permissions' => [
        ...
        PermissionSlug::ComponentsView->value => ['name' => 'View components', 'group' => 'components'],
        PermissionSlug::ComponentsManage->value => ['name' => 'Manage components', 'group' => 'components'],
        ...
        PermissionSlug::IncidentsView->value => ['name' => 'View incidents', 'group' => 'incidents'],
        PermissionSlug::IncidentsManage->value => ['name' => 'Manage incidents', 'group' => 'incidents'],
        PermissionSlug::SdlView->value => ['name' => 'View SDL runs', 'group' => 'sdl'],
        PermissionSlug::SdlManage->value => ['name' => 'Manage SDL runs', 'group' => 'sdl'],
        PermissionSlug::TechnicalDocumentationView->value => ['name' => 'View technical documentation', 'group' => 'technical_documentation'],
        PermissionSlug::TechnicalDocumentationManage->value => ['name' => 'Manage technical documentation', 'group' => 'technical_documentation'],
        ...
        PermissionSlug::TasksView->value => ['name' => 'View tasks', 'group' => 'tasks'],
        PermissionSlug::TasksManage->value => ['name' => 'Manage tasks', 'group' => 'tasks'],
        PermissionSlug::TasksApprove->value => ['name' => 'Approve tasks', 'group' => 'tasks'],
