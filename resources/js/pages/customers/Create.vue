...
usePageBreadcrumbs(() => [
    ...
    { titleKey: 'customers.create_title', href: customersCreate() },
]);
...
const form = useForm({
    ...
    external_ref: '',
    primary_contact: '',
    criticality: props.options.criticalities.includes('medium')
        ? 'medium'
        : (props.options.criticalities[0] ?? 'medium'),
    notes: '',
    is_active: true,
});
    ...
    <div class="mx-auto w-full max-w-3xl space-y-6">
        ...
        <form class="space-y-5 rounded-lg border p-6" @submit.prevent="submit">
            ...
            <div class="grid gap-2">
                ...
                <Input id="primary_contact" v-model="form.primary_contact" />
                <p class="text-sm text-muted-foreground">
