...
export type ProductIncidentListItem = {
    id: number;
    title: string;
    status: string;
    severity: string;
...
export function createProductIncidentColumnTitleMap(
    t: TranslateFn,
...
export const createProductIncidentColumns = ({
    t,
    productId,
    canManage,
    onDelete,
...
}): ColumnDef<ProductIncidentListItem>[] => {
    return [
        {
            accessorKey: 'id',
            header: ({ column }) =>
