...
Собствените продукти на разработчика могат да бъдат използвани за dogfooding:
...
# 12. Първи dogfooding сценарий

## Примерен продукт

WooCommerce BORICA payment module.
...
## Седмици 11–12: Dogfooding

- въвеждане на поне два собствени продукта;
- симулиране на vulnerability;
- симулиране на incident;
- създаване на release;
- проследяване на patch към клиент;
- записване на неудобствата;
- премахване на ненужните полета;
- корекция на workflow.
...
- [ ] Избор на два собствени продукта за dogfooding.
...
- [ ] Поне един incident е симулиран.
- [ ] Поне един release е преминал през readiness gate.
- [ ] SBOM import работи за Composer.
- [ ] Regulatory content е versioned.
- [ ] Evidence има hash и history.
- [ ] Reporting deadlines се изчисляват от awareness timestamp.
- [ ] Ролите и approvals работят.
- [ ] Readiness report може да бъде експортиран.
