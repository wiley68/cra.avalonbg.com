...
**Дата:** 24 юли 2026 г.  
**Статус:** MVP 0.1 exited → Phase 2.1–2.7 Closed → Phase 2.8 Active (Must Done; Should Done; Could open)  
...
> **Статус:** Active — Must Done; Should Done (2026-07-24); Could open — [Phase2_8_Integration_Wave2.md](Phase2_8_Integration_Wave2.md); ops: [Phase2_8_Integrations_Operator_Runbook.md](Phase2_8_Integrations_Operator_Runbook.md).
...
- [Phase2_8_Integration_Wave2.md](Phase2_8_Integration_Wave2.md) — Active: Integration wave 2 — Must Done; Should Done; Could open ([Phase2_8_Integrations_Operator_Runbook.md](Phase2_8_Integrations_Operator_Runbook.md)).
