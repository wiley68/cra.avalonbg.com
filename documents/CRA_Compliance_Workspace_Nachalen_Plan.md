...
**Версия на документа:** 1.3  
**Дата:** 22 юли 2026 г.  
**Статус:** MVP 0.1 exited → Phase 2.1–2.3 Closed → Phase 2.4 Active  
...
> **Статус (2026-07-22):** MVP 0.1 **Done / exited**. Phase 2.1–2.3 **Closed**. Активен план: [Phase2_4_User_Security_Instructions.md](Phase2_4_User_Security_Instructions.md).
...
MVP 0.1 е **exited** и готов за вътрешна употреба. Втора фаза (§14): Phase 2.1–2.3 са **Closed**. Следва [Phase2_4_User_Security_Instructions.md](Phase2_4_User_Security_Instructions.md).
...
> MVP 0.1 е затворен. Phase 2.1 GitHub/GitLab е **Closed** ([Phase2_1_GitHub_GitLab_Integration.md](Phase2_1_GitHub_GitLab_Integration.md)). Phase 2.2 Customer deployments е **Closed** ([Phase2_2_Release_Closeout.md](Phase2_2_Release_Closeout.md)). Phase 2.3 Policy / Auditor / AI е **Closed** ([Phase2_3_Release_Closeout.md](Phase2_3_Release_Closeout.md)).
...
> **Статус:** Active — skeleton — [Phase2_4_User_Security_Instructions.md](Phase2_4_User_Security_Instructions.md).
...
- [Phase2_4_User_Security_Instructions.md](Phase2_4_User_Security_Instructions.md) — Active: User Security Instructions skeleton.
