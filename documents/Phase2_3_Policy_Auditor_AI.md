...
**Версия:** 1.1  
**Дата:** 21 юли 2026 г.  
**Статус:** Active — 2.3A Policy library Must Done; 2.3B–C pending  
...
7. Readiness gap `policies_missing` / `policies_review_due`
8. Publish approved policy → Evidence (`type=policy`)
9. Link from controls/requirements UI to relevant policy types

#### Could

10. Markdown preview + diff between versions
