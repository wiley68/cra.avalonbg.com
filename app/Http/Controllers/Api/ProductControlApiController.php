...
class ProductControlApiController extends Controller
{
    ...
    public function index(Request $request, Product $product): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'page' => 'integer|min:1',
            'sort_by' => 'nullable|string|in:id,name,code,status,reviewed_at',
            'sort_desc' => 'in:0,1',
            'search' => 'nullable|string|max:255',
        ]);

        $paginator = $this->controls->paginateProductControls(
            $product,
