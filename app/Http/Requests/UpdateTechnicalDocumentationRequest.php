...
class UpdateTechnicalDocumentationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'sections.*.manual_pack' => ['sometimes', 'nullable', 'array'],
            'sections.*.manual_pack.kind' => ['sometimes', 'string', 'max:80'],
            'sections.*.manual_pack.path_summary' => ['nullable', 'string', 'max:5000'],
            'sections.*.manual_pack.items' => ['sometimes', 'array'],
            'sections.*.manual_pack.items.*.key' => ['required_with:sections.*.manual_pack.items', 'string', 'max:80'],
            'sections.*.manual_pack.items.*.done' => ['sometimes', 'boolean'],
            'sections.*.manual_pack.items.*.notes' => ['nullable', 'string', 'max:2000'],
            'sections.*.manual_pack.fields' => ['sometimes', 'array'],
            'sections.*.manual_pack.fields.*' => ['nullable', 'string', 'max:2000'],
            'sections.*.manual_pack.reviewed' => ['sometimes', 'boolean'],
