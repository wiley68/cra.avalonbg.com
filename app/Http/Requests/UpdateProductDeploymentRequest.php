...
class UpdateProductDeploymentRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        /** @var ProductDeployment $deployment */
        $deployment = $this->route('deployment');

        return $organization !== null
            && $product->organization_id === $organization->id
            && $deployment instanceof ProductDeployment
            && $deployment->product_id === $product->id
