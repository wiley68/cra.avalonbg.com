...
use App\Policies\AuditorReviewPackagePolicy;
use App\Policies\ControlPolicy;
use App\Policies\OrganizationPolicy;
use App\Policies\OrgPolicyPolicy;
...
use App\Policies\ProductIncidentPolicy;
use App\Policies\ProductVulnerabilityPolicy;
use App\Policies\EvidencePolicy;
use App\Policies\RequirementPolicy;
use App\Policies\SdlRunPolicy;
use App\Policies\TechnicalDocumentationPackagePolicy;
use App\Policies\TaskPolicy;
use App\Policies\UserPolicy;
use App\Policies\UserSecurityInstructionPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    protected function configureAuthorization(): void
    {
        ...
        Gate::policy(OrgPolicy::class, OrgPolicyPolicy::class);
        Gate::policy(UserSecurityInstruction::class, UserSecurityInstructionPolicy::class);
        Gate::policy(AuditorReviewPackage::class, AuditorReviewPackagePolicy::class);
        Gate::policy(AuditorFinding::class, AuditorFindingPolicy::class);
        ...
        Gate::policy(ProductIncident::class, ProductIncidentPolicy::class);
        Gate::policy(SdlRun::class, SdlRunPolicy::class);
        Gate::policy(TechnicalDocumentationPackage::class, TechnicalDocumentationPackagePolicy::class);
