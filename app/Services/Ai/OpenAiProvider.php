...
class OpenAiProvider implements AiProvider
{
    ...
    public function complete(array $messages, array $options = []): array
    {
        ...
        } elseif ($mode === 'tech_doc_section_draft') {
            $system .= "\n\n" . AiTechDocSectionDraftPrompt::systemAddon();
        } elseif ($mode === 'incident_summary') {
            $system .= "\n\n" . AiIncidentSummaryDraftPrompt::systemAddon();
        } elseif ($mode === 'merged_pr_narrative') {
            $system .= "\n\n" . AiMergedPrNarrativePrompt::systemAddon();
        ...
        if (in_array($mode, ['document_analyse', 'draft_generate', 'usi_section_draft', 'tech_doc_section_draft', 'incident_summary', 'merged_pr_narrative', 'sdl_stage_notes', 'vulnerability_triage', 'imported_finding_triage'], true)) {
